...
$Frame3 = [FrameView]::new()
$Frame3.Width = [Dim]::Percent(50)
$Frame3.Height = [Dim]::Percent(50)
$Frame3.X = [Pos]::Right($Frame1)
$Frame3.Y = [Pos]::Bottom($Frame2)
...
$Label3 = [Label]::New()
$Label3.Text = "Frame 3 content, what a great time to make content!"
$Label3.Height = 1
$Label3.Width = 20
$Frame3.Add($Label3)
